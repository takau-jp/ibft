...
#    Updated: 2021/12/05 00:39:43 by stanaka          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCDIR	= ./srcs
SRCS	= ${addprefix ${SRCDIR}/ctype/, ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c}
SRCS	+= ${addprefix ${SRCDIR}/stdio/, ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c}
SRCS	+= ${addprefix ${SRCDIR}/stdlib/, ft_atoi.c ft_calloc.c ft_itoa.c}
...
SRCS	+= ${addprefix ${SRCDIR}/utils/, ft_abs.c ft_labs.c ft_strcat.c ft_strndup.c ft_strnlen.c}
